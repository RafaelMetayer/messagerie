 ...
 */
final class Version20200205161251 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE groupe (id INT AUTO_INCREMENT NOT NULL, users_p_id INT NOT NULL, nom VARCHAR(50) NOT NULL, photo VARCHAR(255) DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_4B98C211CF22DAC (users_p_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, groupe_id INT NOT NULL, content VARCHAR(255) NOT NULL, date_time DATETIME NOT NULL, state INT NOT NULL, INDEX IDX_B6BD307FA76ED395 (user_id), INDEX IDX_B6BD307F7A45358C (groupe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
